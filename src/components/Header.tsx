...
const Header: React.FC = () => {
  ...
  return (
    <header className="sticky top-0 z-40 w-full bg-white dark:bg-dark-bg shadow-sm transition-colors duration-300">
      <div className="w-full bg-brand-blue dark:bg-dark-accent h-1 transition-colors duration-300"></div>
        ...
        <div className="flex justify-between items-center py-4">
          ...
          <Link to="/" className="flex items-center space-x-2">
            <div className="flex items-center">
              ...
              <div className="ml-2">
                <span className="font-heading font-bold text-xl md:text-2xl text-brand-blue dark:text-dark-accent transition-colors duration-300">
                  Virgir
                </span>
          ...
          <div className="md:hidden flex items-center space-x-4">
            ...
            >
              {mobileMenuOpen ? (
                <X size={24} className="text-brand-blue dark:text-dark-accent transition-colors duration-300" />
              ) : (
                <Menu size={24} className="text-brand-blue dark:text-dark-accent transition-colors duration-300" />
              )}
            </button>
          </div>
        </div>
