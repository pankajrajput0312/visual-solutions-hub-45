...
const BlogHeader: React.FC = () => {
  return (
    <section className="py-20 bg-gradient-to-r from-brand-navy to-brand-blue dark:from-dark-bg dark:to-dark-surface text-white dark:text-dark-text relative overflow-hidden transition-colors duration-300">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        ...
        <p className="text-xl text-white/90 dark:text-dark-text-secondary max-w-3xl mx-auto leading-relaxed transition-colors duration-300">
