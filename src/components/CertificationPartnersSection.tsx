      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-wrap justify-center items-center gap-12 mt-6">
          <div className="text-center transition-transform hover:scale-105 duration-300">
            <p className="text-sm text-brand-gray dark:text-white mb-3 font-medium transition-colors duration-300">Available On</p>
          ...
          <div className="text-center transition-transform hover:scale-105 duration-300">
            <p className="text-sm text-brand-gray dark:text-white mb-3 font-medium transition-colors duration-300">Promoting</p>
