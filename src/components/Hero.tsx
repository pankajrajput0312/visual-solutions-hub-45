    ...
    <section className="relative min-h-[650px] flex items-center bg-gradient-to-r from-blue-50/80 to-white dark:from-dark-bg dark:to-dark-surface transition-colors duration-300">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10 flex items-center min-h-[500px]">
        <div className="max-w-2xl animate-fade-in bg-white/80 dark:bg-dark-card/90 rounded-xl shadow-xl p-10 md:p-14 backdrop-blur-md transition-colors duration-300">
          <span className="text-xs font-semibold text-brand-blue dark:text-dark-accent bg-white dark:bg-dark-surface px-3 py-1 rounded-full shadow inline-block mb-4 transition-colors duration-300">
          ...
          <h1 className="text-4xl md:text-5xl font-extrabold text-brand-navy dark:text-dark-text drop-shadow mb-4 transition-colors duration-300">
            Virgir: Product Distribution & Video Conferencing Solutions
          </h1>
          <p className="text-lg md:text-xl text-brand-gray dark:text-dark-text-secondary mb-6 transition-colors duration-300">
          ...
          <div className="flex gap-8 mb-8">
            <div className="flex flex-col items-center">
              <Video className="text-brand-blue dark:text-dark-accent w-8 h-8 transition-colors duration-300" />
              <span className="text-xs mt-2 text-brand-gray dark:text-dark-text-secondary transition-colors duration-300">Video Conferencing</span>
            </div>
            <div className="flex flex-col items-center">
              <Monitor className="text-brand-blue dark:text-dark-accent w-8 h-8 transition-colors duration-300" />
              <span className="text-xs mt-2 text-brand-gray dark:text-dark-text-secondary transition-colors duration-300">AV Solutions</span>
            </div>
            <div className="flex flex-col items-center">
              <Users className="text-brand-blue dark:text-dark-accent w-8 h-8 transition-colors duration-300" />
              <span className="text-xs mt-2 text-brand-gray dark:text-dark-text-secondary transition-colors duration-300">Collaboration</span>
            </div>
          </div>
      ...
      {showModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-white/80 dark:bg-dark-bg/80 transition-colors duration-300">
          <div className="bg-white dark:bg-dark-card rounded-lg shadow-lg p-4 max-w-4xl w-full relative min-h-[80vh] flex flex-col transition-colors duration-300">
            <button
              className="absolute top-2 right-2 text-gray-500 dark:text-dark-text-secondary hover:text-gray-800 dark:hover:text-dark-text text-3xl transition-colors duration-300"
